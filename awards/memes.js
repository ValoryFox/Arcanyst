    ...
    OrderOfTheRose: {
        ...
        Award.Orders[awd].LoadAward = (async function(context, rank = 0, variant, fields = {})
        {
            ...
            await context.Group(async function(context) {
                ...
                await context.AddImage(`awards/battle/martial/symbol_${rank}.png`, {mode: "multiply"}, symbolPosition);
                await context.AddImage(`awards/battle/martial/over_${rank}.png`, symbolPosition);
                
            },null, { draw_type: 'jpeg' });
            fields.AwardText_Flavour = `Neither the flame of your fighting spirit, nor the tales of your martial feats shall ever be extinguished.<br/><br/>To say you've reached the apex of your ability would be to drastically underestimate you.`;
            fields.AwardText_Order = `<span style="font-size:0.8em">Order of the <span style="position:relative;margin-right: 0.25em;"><img src="resources/elements/writing-line.png" style="position:absolute;top: 0.5em;height: 20px;right: -0.25em;left: -0.25em;width: calc(100% + 0.5em);" class="Underline"/><span>Warrior</span></span> Rose</span>`
            
            if (rank != 0)
            await context.AddImage(`${path}/rank_${rank}.png`, { x : 965, y: 2870, width : 620, height: 400 });
            await Award.Components.Text(context, awd_title, awd_flavour[rank], rank, fields, 
                { _nodes: {'.Award': { 'style': 'padding:20% 17% 15% 17%;' }, 'section.SignAndDate': { style: 'min-height:500px;'}}});
