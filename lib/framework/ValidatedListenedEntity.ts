class ValidatedListenedEntity
{
    ...
    #listeners = {};
    constructor(_validatedProperties : string[], listeners : object = { }) {
    ...
    _changes : { property : string, from : any; to : any}[];
    ...
    addEventListener(property : string, callback : Function)
    {
        this.#listeners[property].push(callback);
    }

    async setListenedProperty(property : string, to : any) : Promise<void>
    {
    ...
    async validate(property : string, from : any, to : any) { }
}
